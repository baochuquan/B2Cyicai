			...
			function(data,textStatus){
				...
				switch(data)
				{
					case "Success":
						...
						$("#registertitle").after('<div class="text-center"><span class="center icon fa fa-check fa-4x" style="color:#00bb00"></span></div><p class="text-center"><small>感谢您的注册！激活码已经发送至您的邮箱。请点击邮件中的链接以激活您的账户。<small></p><p id="timedown" class="text-center"></p>');

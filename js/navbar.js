...
$(function(){
	...
	if($.cookie(COOKIE_NAME) != ""){
		...
		content += '<ul class="dropdown-menu"><li><a href="change_password.html">修改密码</a></li><li><a href="#">账户设置</a></li><li><a href="#">已买到宝贝</a></li>'
		if ($.cookie(COOKIE_LEVEL) == 1) {
			content +=  '<li role="separator" class="divider"></li><li><a href="order_management.php">订单管理</a></li><li><a href="product_management.php">产品管理</a></li><li><a href="customer_management.php">客户管理</a></li><li role="separator" class="divider"></li>'
		}

...
$(function(){
	...
	$(".checkbox").click(function(){
		...
		$.getScript("admin/js/editProduct/validateSizeDetail.js");
	});
	...
	$('#addproductform :input').focus(function(){
		...
		if($(this).is('#newproductcolor')) {
			...
			$.post("admin/php/editProduct/getColor.php", function (dataa, status){
				//alert("Rec: "+dataa);				
	...
	$("#newproductimg").change(function(){
		...
		$.ajax({
			url:'admin/php/editProduct/upload_image.php',
			type:'POST',
			data:data,
			cache:false,
			contentType:false,
		...
		$.post("admin/php/editProduct/add_product.php", {
			...
			function (data, status){
				if(data == 'Success'){
					...
					$("#addproductform").hide();
					$("#addproducttitle small").text("编辑失败");
